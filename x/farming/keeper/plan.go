...
// GetPlanRecord implements PlanI.
func (k Keeper) GetPlanRecord(ctx sdk.Context, plan types.PlanI) (plan types.PlanRecord, found bool) {
	//plan
}
...
// GetGlobalPlanId returns and increments the global Plan ID counter.
